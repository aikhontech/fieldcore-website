...
export const consumableProducts: Product[] = [
  {
    ...
    short: "Electrical solder wire for wiring, electronics assembly, and repair work.",
    description:
    ...
    specs: [
      ...
      { label: "Ordering", value: "Contact Sales for pricing and availability" },
    ],
    status: "Available",
    images: [
      {
  ...
  {
    slug: "fc-flux-paste-lead-free-4oz",
    name: "Lead-Free Soldering Flux Paste (4 oz)",
    sku: "FC-FLUX-PASTE-LF-4OZ",
    category: "Accessories",
    group: "Consumables",
    parentSlug: "consumables",
    short: "Lead-free soldering flux paste for soldering, rework, and metal joining applications.",
    description:
